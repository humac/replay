...
- `js/coaching.js`: coach workspace (`/coach`) and player/family feedback (`/feedback`) mixin — roster links, timestamped notes, freehand drawing overlay metadata, review playlists, and "My Feedback" review tracking
