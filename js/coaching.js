...
export const coachingMixin = {
    ...
    renderCoachReviewTacticalBoard(intent) {
        ...
        // Direct editor mode — starts immediately in the editor, auto-saves
        // on every committed stroke via setBoard. No preview/add-board step.
        this.mountTacticalBoardEditorDirect(mount, {
    ...
    _resetCrObsFields() {
        ...
        // Clear the board scene and re-mount the direct editor so the pitch is blank.
        this._coachReviewBoardScene = null;
        const mount = document.getElementById('cr-board-editor-mount');
        if (mount) {
            this.mountTacticalBoardEditorDirect(mount, {
